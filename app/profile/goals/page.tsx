...
export default function GoalsPage() {
  ...
  const targetsTotal = goals.reduce((sum, goal) => sum + goal.targetAmount, 0);
          ...
          <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-purple-400/20 via-blue-400/10 to-white/[0.04] p-5 shadow-2xl shadow-black/30">
            ...
            <div className="mt-4 rounded-3xl bg-black/20 p-4">
              <div className="flex items-center justify-between gap-4">
                <p className="text-sm text-slate-400">Сумма всех целей</p>
                <p className="font-semibold">{formatMoney(targetsTotal)}</p>
              </div>
            </div>
          </section>
