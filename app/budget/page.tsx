        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-orange-400/20 via-emerald-400/10 to-white/[0.04] p-5 shadow-2xl shadow-black/30">
          ...
          <div className="mt-6">
            <div className="mb-2 flex justify-between text-sm">
              ...
              <span
                className={getProgressTextColor(totalProgress, isTotalOverLimit)}
              >
                {totalProgress}%
              </span>
            </div>
        ...
        <section className="grid grid-cols-3 gap-3">
          ...
          <div className="rounded-3xl border border-emerald-400/20 bg-emerald-400/10 p-4">
            ...
            <p className="mt-2 text-2xl font-bold text-emerald-300">
              {budgets.filter((budget) => budget.spent <= budget.limit).length}
            </p>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between gap-4 text-sm">
                  ...
                  <p
                    className={
                      isOverLimit ? "font-semibold text-rose-300" : "font-semibold text-emerald-300"
                    }
                  >
